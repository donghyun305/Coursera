...
data['cluster'] = preds
clusters = []
clusters.append(data[data['cluster']==0])
clusters.append(data[data['cluster']==1])
clusters.append(data[data['cluster']==2])
clusters.append(data[data['cluster']==3])
print(data.columns)
# print(clusters[0].describe())
# print(clusters[1].describe())
# print(clusters[2].describe())
# print(clusters[3].describe())
col = data.columns
info=[]
for i in col:
    info.append((clusters[2][i].sum())/len(clusters[2]))
print(info)
